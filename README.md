...
6. Click **View Replay** on a game to step through a visual board reconstruction turn by turn - shows card images, DON!! attached to characters and the leader, both leaders, and both players' hands; newly drawn cards are highlighted with a yellow ring, and counter actions are highlighted in the action log
